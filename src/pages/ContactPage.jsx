      ...
      <div className="py-20 bg-white">
        <div className="max-w-[1400px] mx-auto px-[5%]">
          ...
          <div className="text-center mb-14">
            <h2 className="font-heading text-navy text-3xl md:text-5xl font-bold mb-4">Get In Touch</h2>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <input type="tel" name="phone" placeholder="(555) 123-4567" value={form.phone} onChange={handleChange} className={inputClass} />
                </div>
                <div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-navy text-white py-4 rounded-full font-semibold
                    hover:bg-teal transition-colors duration-300 cursor-pointer border-none"
                >
                  Send Message
                  <Send size={20} />
                </button>
