      ...
      <div className="bg-white w-full rounded-2xl max-w-lg sm:max-w-2xl max-h-[90vh] flex flex-col overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center gap-5 px-8 py-6 border-b border-gray-100 shrink-0">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[#0891B2] text-sm font-medium mt-0.5">{person.role}</p>
          </div>
          <button
            onClick={onClose}
...
function LeaderCard({ person, featured = false, onBioClick }) {
  ...
  return (
    <>
      ...
      >
        {/* Photo circle */}
        <div className={`relative mb-5 ${featured ? "w-44 h-44" : "w-36 h-36"}`}>
          {/* Gradient ring */}
          <div
        ...
        {/* Name & role */}
        <div className="px-2">
          <h3 className={`font-heading text-white font-bold leading-tight mb-1
  ...
  return (
    <main className="pt-[90px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-500 leading-relaxed mb-8">
                ...
                world-class neuroscience education should be within reach of every learner.
                Through cutting-edge tools and innovative methodologies, we bridge the gap
                between foundational study and specialized clinical expertise, empowering
                medical students and professionals at every stage of their journey.
              </p>
              <Link
                to="/contact"
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, #0a1535 0%, #1E3A8A 60%, #0d1f4a 100%)",
        }}
      >
        {/* Dot grid texture */}
        <div
        ...
        <div className="max-w-[1400px] mx-auto px-[5%]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {[
              ...
              >
                <div className="w-20 h-20 bg-gradient-to-br from-[#1E3A8A] to-[#0891B2]
                                rounded-2xl flex items-center justify-center text-white mx-auto mb-6">
                  {icon}
                </div>
                <h3 className="font-heading text-[#1E3A8A] text-xl font-bold mb-3">{title}</h3>
